...
export interface IDVSteps {
  verify_sms: IDVStepStatus;
  kyc_check: IDVStepStatus;
  documentary_verification: IDVStepStatus;
  selfie_check: IDVStepStatus;
  watchlist_screening: IDVStepStatus;
  risk_check: IDVStepStatus;
}
...
export interface IdentityVerification {
  ...
  status: IDVStatus;
  steps: IDVSteps;
  documentary_verification: unknown | null;
  selfie_check: unknown | null;
  kyc_check: unknown | null;
  risk_check: unknown | null;
  watchlist_screening_id: string | null;
}

export interface CreateIDVParams {
  clientUserId: string;
  templateId: string;
  isShareable?: boolean;
...
export interface CreateLinkTokenForIDVParams {
  userId: string;
  templateId: string;
  gaveConsent?: boolean;
  isShareable?: boolean;
