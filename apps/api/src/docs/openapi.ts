...
All responses include a \`requestId\` for debugging and support purposes.
  ...
  components: {
    ...
    schemas: {
      ...
      CreateOrderRequest: {
        type: "object",
        required: ["assetClass", "symbol", "side", "type", "quantity"],
        properties: {
          assetClass: {
            type: "string",
      ...
      Order: {
        type: "object",
        required: ["id", "userId", "assetClass", "symbol", "side", "type", "quantity", "status", "createdAt"],
        properties: {
          id: {
            type: "string",
      ...
      Portfolio: {
        ...
        properties: {
          ...
          summary: {
            type: "object",
            required: ["totalValue", "totalCost", "totalUnrealizedPnL", "totalRealizedPnL", "totalPnLPercent", "positionCount"],
            properties: {
              totalValue: {
                type: "number",
      ...
      Position: {
        type: "object",
        required: ["symbol", "assetClass", "quantity", "averageCost", "currentPrice", "marketValue"],
        properties: {
          symbol: {
            type: "string",
      ...
      BuyingPower: {
        type: "object",
        required: ["available", "held", "pending", "total"],
        properties: {
          available: {
            type: "number",
      ...
      PredictionEvent: {
        type: "object",
        required: ["id", "ticker", "title", "status", "category"],
        properties: {
          id: {
            type: "string",
      ...
      PredictionMarket: {
        type: "object",
        required: ["id", "ticker", "question", "yesPrice", "noPrice"],
        properties: {
          id: {
            type: "string",
      ...
      PredictionPosition: {
        type: "object",
        required: ["marketId", "ticker", "side", "quantity", "averageCost"],
        properties: {
          marketId: {
            type: "string",
            description: "Market ID",
      ...
      RWAAsset: {
        type: "object",
        required: ["id", "name", "type", "status", "totalShares", "pricePerShare"],
        properties: {
          id: {
            type: "string",
      ...
      RWAListing: {
        type: "object",
        required: ["id", "assetId", "shares", "pricePerShare", "status"],
        properties: {
          id: {
            type: "string",
      ...
      RWAOwnership: {
        type: "object",
        required: ["assetId", "shares", "averageCost"],
        properties: {
          assetId: {
            type: "string",
            description: "Asset ID",
      ...
      RewardsBalance: {
        type: "object",
        required: ["available", "pending", "lifetime"],
        properties: {
          available: {
            type: "integer",
      ...
      Reward: {
        type: "object",
        required: ["id", "name", "pointsCost", "category", "status"],
        properties: {
          id: {
            type: "string",
      ...
      RedeemRequest: {
        ...
        properties: {
          ...
          shippingAddress: {
            type: "object",
            description: "Required for physical rewards",
            properties: {
      ...
      LeaderboardEntry: {
        type: "object",
        required: ["rank", "userId", "displayName", "points"],
        properties: {
          rank: {
            type: "integer",
      ...
      DailyStreakResponse: {
        type: "object",
        required: ["bonusAmount", "streakDays"],
        properties: {
          bonusAmount: {
            type: "integer",
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    success: { type: "boolean", enum: [true] },
                    data: { $ref: "#/components/schemas/OrderWithFills" },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              },
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    success: { type: "boolean", enum: [true] },
                    data: { $ref: "#/components/schemas/BuyingPower" },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              },
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    success: { type: "boolean", enum: [true] },
                    data: { $ref: "#/components/schemas/PredictionEvent" },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "array",
                      items: { $ref: "#/components/schemas/PredictionPosition" },
                    },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "array",
                      items: { $ref: "#/components/schemas/RWAAsset" },
                    },
                    pagination: { $ref: "#/components/schemas/Pagination" },
                    timestamp: { type: "string", format: "date-time" },
                  },
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    success: { type: "boolean", enum: [true] },
                    data: { $ref: "#/components/schemas/RWAAsset" },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "array",
                      items: { $ref: "#/components/schemas/RWAListing" },
                    },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "array",
                      items: { $ref: "#/components/schemas/RWAOwnership" },
                    },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    success: { type: "boolean", enum: [true] },
                    data: { $ref: "#/components/schemas/RewardsBalance" },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              },
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    success: { type: "boolean", enum: [true] },
                    data: { $ref: "#/components/schemas/DailyStreakResponse" },
                    timestamp: { type: "string", format: "date-time" },
                  },
                },
              },
